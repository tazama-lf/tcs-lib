...
export interface FunctionDefinition {
    params: string[];
    functionName: 'addAccountHolder' | 'addEntity' | 'addAccount';
}
...
export type WorkflowAction = 'submit_for_approval' | 'approve' | 'reject' | 'request_changes' | 'deploy' | 'return_to_progress';
