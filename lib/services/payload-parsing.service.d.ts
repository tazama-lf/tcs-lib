...
export declare const parsePayloadToSchema: (
  payload: string,
  contentType: ContentType,
  _filename?: string,
) => Promise<PayloadParsingResult | undefined>;
export declare const applyFieldAdjustments: (
  sourceFields: SchemaField[],
  adjustments: AdjustFieldDto[],
) => SchemaField[];
export declare const validatePayloadStructure: (
  payload: string,
  contentType: ContentType,
) => Promise<SchemaValidationResultDto>;
export declare const addStructureError: (
  error: any,
  contentType: ContentType,
  errors: string[],
) => void;
export declare const validateJsonStructure: (
  parsed: any,
  errors: string[],
  warnings: string[],
) => void;
export declare const validateXmlStructure: (
  xmlString: string,
  errors: string[],
  warnings: string[],
) => void;
export declare const calculateObjectDepth: (obj: any, currentDepth?: number) => number;
export declare const parsePayloadToObject: (
  payload: string,
  contentType: ContentType,
) => Promise<any>;
export declare const generateHierarchicalSchema: (
  obj: any,
  parentPath: string,
  level?: number,
) => SchemaField[];
export declare const createSchemaField: (
  name: string,
  path: string,
  value: any,
  level: number,
...
export declare const validateFieldsRecursively: (
  fields: SchemaField[],
  errors: string[],
  warnings: string[],
  invalidTypes: string[],
...
export declare const applyAdjustmentsRecursively: (
  fields: SchemaField[],
  adjustmentMap: Map<string, AdjustFieldDto>,
) => SchemaField[];
export declare const calculateSchemaMetadata: (
  fields: SchemaField[],
  originalPayload: string,
  processingTime: number,
) => PayloadParsingResult['metadata'];
export declare const flattenFields: (fields: SchemaField[]) => SchemaField[];
export declare const calculateMaxNestedLevels: (
  fields: SchemaField[],
  currentLevel?: number,
) => number;
export declare const createEmptyMetadata: (
  payload: string,
  processingTime: number,
) => PayloadParsingResult['metadata'];
